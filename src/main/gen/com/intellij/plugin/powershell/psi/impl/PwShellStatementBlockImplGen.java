...
public class PwShellStatementBlockImplGen extends PwShellPsiElementImpl implements PwShellStatementBlock {

  public PwShellStatementBlockImplGen(ASTNode node) {
    super(node);
  }
