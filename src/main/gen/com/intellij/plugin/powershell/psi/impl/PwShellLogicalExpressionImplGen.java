...
import com.intellij.plugin.powershell.psi.PwShellLogicalExpression;
...
public class PwShellLogicalExpressionImplGen extends PwShellExpressionImplGen implements PwShellLogicalExpression {

  public PwShellLogicalExpressionImplGen(ASTNode node) {
    super(node);
  }
