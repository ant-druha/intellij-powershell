...
public class PowerShellLogicalExpressionImplGen extends PowerShellExpressionImplGen implements PowerShellLogicalExpression {

  public PowerShellLogicalExpressionImplGen(@NotNull ASTNode node) {
    super(node);
  }
