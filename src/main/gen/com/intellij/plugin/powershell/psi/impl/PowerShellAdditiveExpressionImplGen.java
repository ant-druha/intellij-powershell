...
public class PowerShellAdditiveExpressionImplGen extends PowerShellExpressionImplGen implements PowerShellAdditiveExpression {

  public PowerShellAdditiveExpressionImplGen(@NotNull ASTNode node) {
    super(node);
  }
