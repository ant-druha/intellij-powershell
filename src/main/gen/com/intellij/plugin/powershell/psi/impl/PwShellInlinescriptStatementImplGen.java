...
import com.intellij.plugin.powershell.psi.PwShellInlinescriptStatement;
...
public class PwShellInlinescriptStatementImplGen extends PwShellPsiElementImpl implements PwShellInlinescriptStatement {

  public PwShellInlinescriptStatementImplGen(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PwShellVisitor visitor) {
    visitor.visitInlinescriptStatement(this);
  }
