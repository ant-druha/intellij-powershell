...
import com.intellij.plugin.powershell.psi.PwShellMultiplicativeExpression;
...
public class PwShellMultiplicativeExpressionImplGen extends PwShellExpressionImplGen implements PwShellMultiplicativeExpression {

  public PwShellMultiplicativeExpressionImplGen(ASTNode node) {
    super(node);
  }
