...
public class PowerShellIdentifierImplGen extends PowerShellPsiElementImpl implements PowerShellIdentifier {

  public PowerShellIdentifierImplGen(@NotNull ASTNode node) {
    super(node);
  }
