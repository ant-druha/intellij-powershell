  ...
  override fun customizeSettings(consumer: CodeStyleSettingsCustomizable, settingsType: SettingsType) {
    when (settingsType) {
      LanguageCodeStyleSettingsProvider.SettingsType.SPACING_SETTINGS -> {
        ...
        consumer.showCustomOption(PowerShellCodeStyleSettings::class.java, "SPACE_WITHIN_SUB_EXPRESSION_PARENTHESES", "Sub-expression parentheses", CodeStyleSettingsCustomizable.SPACES_WITHIN)
      ...
      LanguageCodeStyleSettingsProvider.SettingsType.WRAPPING_AND_BRACES_SETTINGS -> {
        ...
        consumer.showCustomOption(PowerShellCodeStyleSettings::class.java, "KEEP_SIMPLE_HASH_LITERAL_IN_ONE_LINE", "Simple hash literals in one line", CodeStyleSettingsCustomizable.WRAPPING_KEEP)
        consumer.renameStandardOption("METHOD_ANNOTATION_WRAP", "Method attribute")

        consumer.showCustomOption(PowerShellCodeStyleSettings::class.java, "CATCH_TYPE_LIST_WRAP",
        ...
        consumer.showCustomOption(PowerShellCodeStyleSettings::class.java, "ALIGN_MULTILINE_CATCH_TYPE_LIST",
            MessagesBundle.message("code.style.align.multiline"),
            MessagesBundle.message("wrapping.catch,type.list"
            )
        )

        consumer.showCustomOption(PowerShellCodeStyleSettings::class.java, "ATTRIBUTE_ARGUMENT_WRAP",
            ...
            CodeStyleSettingsCustomizable.WRAP_OPTIONS,
            CodeStyleSettingsCustomizable.WRAP_VALUES)
        consumer.showCustomOption(PowerShellCodeStyleSettings::class.java, "ALIGN_MULTILINE_ATTRIBUTE_ARGUMENT",
            MessagesBundle.message("code.style.align.multiline"),
            MessagesBundle.message("wrapping.attribute.argument")
        )
