...
class PowerShellConfigurationProducer : LazyRunConfigurationProducer<PowerShellRunConfiguration>() {
  ...
  override fun getConfigurationFactory(): ConfigurationFactory {
    return PowerShellConfigurationType().configurationFactories[0]
  }
}